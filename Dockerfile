...
RUN git clone https://github.com/nlplab/brat /var/www/brat/brat-master
...
RUN ln -s /bratdata /var/www/brat/brat-master/data
RUN ln -s /bratcfg /var/www/brat/brat-master/cfg 
...
RUN chown -R www-data:www-data /var/www/brat/brat-master/

ADD 000-default.conf /etc/apache2/sites-available/000-default.conf

# add the user patching script
ADD user_patch.py /var/www/brat/brat-master/user_patch.py
